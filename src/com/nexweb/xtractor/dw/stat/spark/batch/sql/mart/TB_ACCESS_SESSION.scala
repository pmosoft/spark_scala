 ...
 * 2019-01-24 | 피승현 | 최초작성
 */
object TB_ACCESS_SESSION {

  var spark : SparkSession = null
  var objNm  = "TB_ACCESS_SESSION"

  var statisDate = ""
  var statisType = ""
  //var objNm  = "TB_ACCESS_SESSION";var statisDate = "20190312"; var statisType = "D"
  def executeDaily() = {
    //------------------------------------------------------
  ...
  def excuteSql() = {
    ...
    FROM
           ...
           SELECT GVHOST
                ...
                , T_ID
                , URL
                , LEAD(URL) OVER(PARTITION BY GVHOST, SESSION_ID ORDER BY START_TIME, URL) NEXT_URL -- Only UrlPathStat
                , PAGE_VIEW
                , START_TIME
                , END_TIME
