...
object CsEventCode {
  ...
  var objNm  = "TB_CS_EVENT_CODE"
  var statisDate = ""
  var statisType = ""
  //var objNm  = "TB_CS_EVENT_CODE"; var statisDate = "20190313"; var statisType = "D"
  ...
  def loadTables() = {
    ...
    LoadTable.lodAllColTable(spark,"CS_EVENT" ,statisDate,statisType,"",true)
  }
