 ...
 * 출    력 : - TB_VISIT_STAT_FRONT
 * 수정내역 :
 * 2018-12-06 | 피승현 | 최초작성
 */
object VisitStatFront {

  var spark : SparkSession = null
  var objNm  = "TB_VISIT_STAT_FRONT"

  var statisDate = ""
  var statisType = ""
  var statisDate2 = ""
  var statisType2 = ""
  //var objNm  = "TB_VISIT_STAT_FRONT";var statisDate = "201904"; var statisDate2 = "20190430"; var statisType = "M"; var statisType2 = "D"
  ...
  def loadTables() = {
    ...
    LoadTable.lodAllColTable(spark,"TB_NCATE_STAT_FRONT" ,statisDate2,statisType2,"",true)
  }
    ...
    FROM
        ...
        FROM
              ...
              FROM
                  ...
                  WHERE '20'||FIRST_VISIT LIKE '${statisDate}%'
                  GROUP BY GVHOST
                  ) TC
