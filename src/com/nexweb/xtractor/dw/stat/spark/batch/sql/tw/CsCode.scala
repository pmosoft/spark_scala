...
object CsCode {
  ...
  var objNm  = "TB_CS_CODE"
  var statisDate = ""
  var statisType = ""
  //var objNm  = "TB_CS_CODE"; var statisDate = "20190313"; var statisType = "D"
  ...
  def loadTables() = {
    ...
    LoadTable.lodAllColTable(spark,"CS_CODE"       ,statisDate,statisType,"",true)
  }
  ...
  def excuteSql() = {
    ...
    qry =
    s"""
      SELECT DISTINCT NVL(UPPER(SUBSTR(TRIM(CS_ID),1,10)),'NO')
